     ...
     <div class="box" :class="placeHolder ? 'place-holder' : ''">
         <div class="level">
             ...
             <div class="level-right">
                 <a  class="is-pulled-right align-vertical tooltip is-tooltip-left" data-tooltip="Add Task" @click.prevent.stop="addTask()" v-if="!placeHolder"><i class="fa fa-plus-circle is-pulled-right align-vertical" aria-hidden="true"></i></a>
